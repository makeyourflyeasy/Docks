...
export interface Client {
  ...
  ntnDocUrl?: string; // NTN certificate photo / doc
  ntnDocName?: string;
...
export interface DestinationStaff {
  ...
  role: 'Loading Agent' | 'Unloading Agent' | 'Clearing Agent' | 'Station Supervisor' | string;
  contact?: string;
  phone?: string;
  ...
  baseRate?: number;
  paymentType?: 'Monthly Salary' | 'Per Case Commission' | 'Daily Rate' | 'MONTHLY_SALARY' | 'PER_CASE_COMMISSION' | 'DAILY_RATE';
...
export interface StaffLedgerEntry {
  ...
  staffName: string;
  type: 'SALARY' | 'DAILY_ROUTINE' | 'DAILY'; // Salary/Fuel/Loan vs Daily Khana Peena / Petty Cash
  date: string;
  description: string;
...
export interface Vendor {
  ...
  address?: string;
  category: string; // e.g., 'Drinking Water', 'Electric Bill', 'Gas Cylinder Refill', 'Internet Bill', 'Office Rent', 'Stationery', 'Miscellaneous', 'Photocopy & Printer', 'Computer Repair', 'Office Maintenance', 'Legal Payments'
  isRecurring?: boolean;
  createdAt?: string;
}

export enum VehicleCategory {
  DOMESTIC = 'Local Transportation',
...
export interface Vehicle {
  ...
  // Fleet Status & Portal Extensions
